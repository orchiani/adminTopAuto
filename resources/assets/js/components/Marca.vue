...
<div>
  <div class="card">
                    <div class="buscador-div">
                        <input v-model="buscar" v-on:input="listarMarcas(1, buscar)" type="textfield" class="buscador" placeholder="Buscar...">
                    </div>
                    <div class="card-body">
                    </div>
                </div>
<div class="tabla-div">
    <table class="table-prueba">
        <thead>
          ...
          <tbody>
            <tr v-on:click="abrirModal('marca', 'actualizar', marca)" v-for="marca in arrayMarcas" :key="marca.codigo">
            <td style="max-width=20%; min-width=15%;" class="table-data-prueba"><div class="div-prueba1" v-text="marca.codigo"> </div> </td>
            <td style="max-width=20%; min-width=20%;" class="table-data-prueba"><div class="div-prueba2" v-text="marca.nombre"> </div> </td>
             </tr>
            <div id="container-floating">
           <div id="floating-button" v-on:click="abrirModal('marca', 'registrar')">
            <p class="plus">+</p>
           </div>
          </div>
          </tbody>
     ...
     <div class="container">
       ...
       <div class="modal-dialog modal-lg">
        ...
        <div class="errores-modal" v-show="errorMarca==1"> 
           <div> 
               <div class="icon-warning" v-for="error in errorMostrarMsjMarca" :key="error" v-text="error">
               </div>
            </div>
         </div>
          <button type="button" class="btn btn-secondary" v-on:click="cerrarModal()" >Cerrar</button>
          <button type="button" class="btn btn-secondary" v-on:click="registrarMarca()" v-if="tipoAccion==1">Guardar</button>
    ...
    export default {
      ...
      methods : {
        ...
        validarMarca(){
           ...
           if(!this.nombre){
             this.errorMostrarMsjMarca.push("El nombre de la marca es requerido");
           } 
           if(!this.codigo){
             this.errorMostrarMsjMarca.push("El código de la marca es requerido");
           } 
      ...
      activarModificarModal(){
        ...
        mounted() {
            this.listarMarcas(1, this.buscar);
    } 
    }
</script>
