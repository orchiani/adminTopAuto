...
<div>
  <div class="card">
                    <div class="buscador-div">
                        <input v-model="buscar" v-on:input="listarCategorias(1, buscar)" type="textfield" class="buscador" placeholder="Buscar...">
                    </div>
                    <div class="card-body">
                    </div>
                </div>
<div class="tabla-div">
    <table class="table-prueba">
        <thead>
          ...
          <tbody>
            <tr v-on:click="abrirModal('categoria', 'actualizar', categoria)" v-for="categoria in arrayCategorias" :key="categoria.codigo">
            <td style="max-width=20%; min-width=15%;" class="table-data-prueba"><div class="div-prueba1" v-text="categoria.codigo"> </div> </td>
            <td style="max-width=20%; min-width=20%;" class="table-data-prueba"><div class="div-prueba2" v-text="categoria.nombre"> </div> </td>
             </tr>
            <div id="container-floating">
           <div id="floating-button" v-on:click="abrirModal('categoria', 'registrar')">
            <p class="plus">+</p>
           </div>
          </div>
          </tbody>
     ...
     <div class="container">
       ...
       <div class="modal-dialog modal-lg">
        ...
        <div class="errores-modal" v-show="errorCategoria==1"> 
           <div> 
               <div class="icon-warning" v-for="error in errorMostrarMsjCategoria" :key="error" v-text="error">
               </div>
            </div>
         </div>
          <button type="button" class="btn btn-secondary" v-on:click="cerrarModal()" >Cerrar</button>
          <button type="button" class="btn btn-secondary" v-on:click="registrarCategoria()" v-if="tipoAccion==1">Guardar</button>
    ...
    export default {
      ...
      methods : {
        ...
        cambiarPagina(page, buscar){
            ...
            me.listarCategorias(page, buscar);
        },
        registrarCategoria(){
            ...
            case "categoria":
              {
                switch(accion){
                  case 'registrar':
                  {
                    ...
                    this.nombre = '';
                    this.codigo = '';
                    this.tituloModal = 'Añadir Categoria';
                    this.tipoAccion = 1;
                    this.modificar = 1;
                    break;
                  }
        ...
        validarCategoria(){
           ...
           if(!this.nombre){
             this.errorMostrarMsjCategoria.push("El nombre de la categoria es requerido");
           } 
           if(!this.codigo){
             this.errorMostrarMsjCategoria.push("El código de la categoria es requerido");
           } 
      ...
      activarModificarModal(){
        ...
        mounted() {
            this.listarCategorias(1, this.buscar);
    } 
    }
</script>
